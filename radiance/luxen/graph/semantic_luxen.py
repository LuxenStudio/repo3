...
from radiance.luxen.field_modules.field_heads import FieldHeadNames, SemanticStuffHead
from radiance.luxen.field_modules.mlp import MLP
from radiance.luxen.graph.vanilla_luxen import LuxenField, LuxenGraph
from radiance.luxen.renderers import SemanticRenderer
from radiance.structures.rays import RayBundle, RaySamples
from radiance.utils import visualization, writer


class SemanticLuxenField(LuxenField):
...
class SemanticLuxenGraph(LuxenGraph):
    ...
    def populate_fields(self):
        ...
        self.field_fine = SemanticLuxenField(num_stuff_classes=len(self.stuff_classes))
