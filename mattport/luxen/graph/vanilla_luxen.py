...
from mattport.luxen.field_modules.field_heads import DensityFieldHead, FieldHeadNames, RGBFieldHead
...
from mattport.luxen.renderers import AccumulationRenderer, DisparityRenderer, RGBRenderer
...
class LuxenField(nn.Module):
    ...
    def __init__(self, num_layers=8, layer_width=256, skip_connections: Tuple = (4,)) -> None:
        ...
        self.encoding_xyz = LuxenEncoding(
