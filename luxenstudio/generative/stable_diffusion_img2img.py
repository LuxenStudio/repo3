...
# Modified from https://github.com/ashawkey/stable-dreamfusion/blob/main/luxen/sd.py
...
class StableDiffusionImg2Img(nn.Module):
    ...
    def __init__(self, device: Union[torch.device, str], num_train_timesteps: int = 1000, version="1-5") -> None:
        ...
        if not SD_AVAILABLE:
            ...
            CONSOLE.print(r"Install using [yellow]pip install luxenstudio\[gen][/yellow]")
        ...
        unet_traced_filename = Path(appdirs.user_data_dir("luxenstudio")) / f"{filename_sd_id}_unet_traced.pt"
    ...
    def search_updates(self, text_embedding, image):
        ...
        for a in range(0, 50, 2):
            ...
            mediapy.write_image(f'/home/terrance/luxenactory/luxenstudio/generative/img2img/7/newsched_test{a}.png', diffused_img)
