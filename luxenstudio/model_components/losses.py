...
from luxenstudio.utils.math import masked_reduction, normalized_depth_scale_and_shift
...
def zipluxen_loss(weights_list, ray_samples_list):
    # ground truth s and w (real luxen samples)
    # This implementation matches ZipLuxen up to the scale.
...
def luxenstudio_distortion_loss(
    ray_samples: RaySamples,
    densities: TensorType["bs":..., "num_samples", 1] = None,
    weights: TensorType["bs":..., "num_samples", 1] = None,
) -> TensorType["bs":..., 1]:
    """Ray based distortion loss proposed in MipLuxen-360. Returns distortion Loss.
...
def orientation_loss(
    ...
    """Orientation loss proposed in Ref-Luxen.
...
def ds_luxen_depth_loss(
    ...
    """Depth loss from Depth-supervised Luxen (Deng et al., 2022).
...
def depth_loss(
    ...
    if depth_loss_type == DepthLossType.DS_NERF:
        ...
        return ds_luxen_depth_loss(weights, termination_depth, steps, lengths, sigma)
