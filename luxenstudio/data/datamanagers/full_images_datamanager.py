...
from luxenstudio.data.datamanagers.base_datamanager import DataManager, DataManagerConfig, TDataset
...
from luxenstudio.data.utils.data_utils import identity_collate
from luxenstudio.data.utils.dataloaders import ImageBatchStream, _undistort_image
...
class FullImageDatamanagerConfig(DataManagerConfig):
    ...
    dataparser: AnnotatedDataParserUnion = field(default_factory=LuxenstudioDataParserConfig)
...
class FullImageDatamanager(DataManager, Generic[TDataset]):
    ...
    def setup_train(self):
        ...
        if self.config.cache_images == "disk":
            ...
            self.train_image_dataloader = DataLoader(
                ...
                collate_fn=luxenstudio_collate,
            )
    ...
    def next_train(self, step: int) -> Tuple[Cameras, Dict]:
        ...
        cameras = luxenstudio_collate([self.train_dataset.cameras[i : i + 1].to(self.device) for i in camera_indices])
