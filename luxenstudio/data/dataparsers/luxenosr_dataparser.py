...
""" Data parser for Luxen-OSR datasets

    Presented in the paper: https://4dqv.mpi-inf.mpg.de/Luxen-OSR/
...
def get_camera_params(
    ...
    for i in range(num_cams):
        ...
        # convert from COLMAP/OpenCV to luxenstudio camera (OpenGL/Blender)
        pose[0:3, 1:3] *= -1
...
@dataclass
class LuxenOSRDataParserConfig(DataParserConfig):
    """Luxenstudio dataset config"""

    _target: Type = field(default_factory=lambda: LuxenOSR)
    """target class to instantiate"""
    data: Path = Path("data/Luxen-OSR/Data/")
...
@dataclass
class LuxenOSR(DataParser):
    """LuxenOSR Dataparser
    Presented in the paper: https://4dqv.mpi-inf.mpg.de/Luxen-OSR/

    Some of this code comes from https://github.com/r00tman/Luxen-OSR/blob/main/data_loader_split.py
    ...
    config: LuxenOSRDataParserConfig
