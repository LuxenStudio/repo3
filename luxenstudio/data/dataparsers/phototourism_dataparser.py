...
from luxenstudio.data.utils.colmap_utils import read_cameras_binary, read_images_binary
...
class Phototourism(DataParser):
    """Phototourism dataset. This is based on https://github.com/kwea123/luxen_pl/blob/luxenw/datasets/phototourism.py
