...
from luxenstudio.utils.math import expected_sin, generate_polyhedron_basis
from luxenstudio.utils.printing import print_tcnn_speed_warning
from luxenstudio.utils.spherical_harmonics import MAX_SH_DEGREE, components_from_spherical_harmonics
...
class LuxenEncoding(Encoding):
    ...
    def __init__(
        ...
        if implementation == "tcnn" and not TCNN_EXISTS:
            print_tcnn_speed_warning("LuxenEncoding")
    ...
    def pytorch_fwd(
        ...
        """Calculates Luxen encoding. If covariances are provided the encodings will be integrated as proposed
            in mip-Luxen.
...
class PolyhedronFFEncoding(FFEncoding):
    """Fourier Feature encoding using polyhedron basis as proposed by mip-Luxen360. Supports integrated encodings.
