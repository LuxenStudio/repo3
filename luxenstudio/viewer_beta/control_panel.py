...
from luxenstudio.viewer_beta.viewer_elements import (  # ViewerButtonGroup,
    ViewerButton,
    ViewerButtonGroup,
    ViewerCheckbox,
    ViewerDropdown,
...
class ControlPanel:
    ...
    def __init__(
        ...
        self._layer_depth = ViewerCheckbox(
            "Composite Depth", True, cb_hook=rerender_cb, hint="Allow Luxen to occlude 3D browser objects"
        )
