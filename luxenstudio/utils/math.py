...
def conical_frustum_to_gaussian(
    ...
    Uses stable parameterization described in mip-Luxen publication.
...
def columnwise_squared_l2_distance(
    ...
    Adapted from https://github.com/google-research/multiluxen/blob/5b4d4f64608ec8077222c52fdf814d40acc10bc1/internal/geopoly.py
...
def generate_polyhedron_basis(
    ...
    See Mip-Luxen360 paper: https://arxiv.org/abs/2111.12077
    Adapted from https://github.com/google-research/multiluxen/blob/5b4d4f64608ec8077222c52fdf814d40acc10bc1/internal/geopoly.py
