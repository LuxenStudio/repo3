...
from luxenstudio.viewer.server.visualizer import Viewer
=======
...
def get_viewer_url(websocket_port: int) -> str:
    ...
    return f"https://viewer.luxen.studio/versions/{version}/?websocket_url={websocket_url}"
...
<<<<<<< HEAD
    def __init__(self, config: cfg.ViewerConfig, log_filename: Path, datapath: Path):
        ...
        if self.config.launch_bridge_server:
            ...
            self.viewer_url = f"https://viewer.luxen.studio/versions/{version}/?websocket_url={websocket_url}"
