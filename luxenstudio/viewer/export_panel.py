...
def populate_point_cloud_tab(
    ...
    if not viewing_gsplat:
        ...
        def _(event: viser.GuiEvent) -> None:
            ...
            from luxenstudio.scripts.exporter import ExportPointCloud
...
def populate_mesh_tab(
    ...
    if not viewing_gsplat:
        ...
        def _(event: viser.GuiEvent) -> None:
            ...
            from luxenstudio.scripts.exporter import ExportPoissonMesh
...
def populate_splat_tab(
    ...
    if viewing_gsplat:
        ...
        def _(event: viser.GuiEvent) -> None:
            ...
            from luxenstudio.scripts.exporter import ExportGaussianSplat
