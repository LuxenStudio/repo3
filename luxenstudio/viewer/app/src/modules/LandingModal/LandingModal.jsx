...
export default function LandingModel(props: LandingModalProps) {
  ...
  const text_intro = `At the top right is the Status Panel where you can connect to a WebSocket and see the train/eval status of your Luxen model. The WebSocket Port takes the form <domain-or-ip_address>:<port>.`;
