...
def populate_render_tab(
    ...
    from luxenstudio.viewer.viewer import VISER_NERFSTUDIO_SCALE_RATIO
    ...
    with auto_camera_folder:
        ...
        def _(event: viser.GuiEvent) -> None:
            ...
            def _(event: viser.ScenePointerEvent) -> None:
                ...
                from luxenstudio.model_components.losses import scale_gradients_by_distance_squared
        ...
        def _(event: viser.GuiEvent) -> None:
            ...
            for i, position in enumerate(camera_coords):
                ...
                if loss > -0.4:
                    ...
                    # backprop through the luxen as the gradient step, input is position
                    camera_path.add_camera(
                        keyframe=Keyframe(
                            position=position,
                            wxyz=wxyz_helper(position),
