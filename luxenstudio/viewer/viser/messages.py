...
class LuxenstudioMessage(viser.infra.Message):
...
class BackgroundImageMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class GuiAddMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class GuiRemoveMessage(LuxenstudioMessage):
    """Sent server->client to add a new GUI input."""
...
@dataclasses.dataclass
class GuiUpdateMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class GuiSetHiddenMessage(LuxenstudioMessage):
    """Sent client->server when a GUI input is changed."""
...
@dataclasses.dataclass
class GuiSetValueMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class GuiSetLevaConfMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class FilePathInfoMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class SetCameraMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class CameraMessage(LuxenstudioMessage):
    """Render camera data."""
...
@dataclasses.dataclass
class SceneBoxMessage(LuxenstudioMessage):
    """Scene Box data."""
...
@dataclasses.dataclass
class DatasetImageMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class CameraPathPayloadMessage(LuxenstudioMessage):
    """Camera path"""
...
@dataclasses.dataclass
class CameraPathOptionsRequest(LuxenstudioMessage):
    """Request list of existing camera paths"""


@dataclasses.dataclass
class CameraPathsMessage(LuxenstudioMessage):
...
@dataclasses.dataclass
class CropParamsMessage(LuxenstudioMessage):
    """Crop parameters"""
...
@dataclasses.dataclass
class StatusMessage(LuxenstudioMessage):
    """Status message."""
...
@dataclasses.dataclass
class ClickMessage(LuxenstudioMessage):
    """Click message."""
