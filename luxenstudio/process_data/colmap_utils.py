...
"""
Tools supporting the execution of COLMAP and preparation of COLMAP-based datasets for luxenstudio training.
"""
...
from luxenstudio.process_data.process_data_utils import CameraModel
...
def colmap_to_json(
    ...
    Args:
        ...
        keep_original_world_coordinate: If True, no extra transform will be applied to world coordinate.
                    ...
                    while luxenstudio world set z direction to be up direction for viewer.
    Returns:
