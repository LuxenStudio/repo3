...
"""Base class to processes a video or image sequence to a luxenstudio compatible dataset."""
...
@dataclass
class ColmapConverterToLuxenstudioDataset(BaseConverterToLuxenstudioDataset):
    """Base class to process images or video into a luxenstudio dataset using colmap"""
