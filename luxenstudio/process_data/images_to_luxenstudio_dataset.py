...
"""Processes an image sequence to a luxenstudio compatible dataset."""

from dataclasses import dataclass
from typing import Optional

from luxenstudio.process_data import equirect_utils, process_data_utils
from luxenstudio.process_data.colmap_converter_to_luxenstudio_dataset import ColmapConverterToLuxenstudioDataset
from luxenstudio.utils.rich_utils import CONSOLE


@dataclass
class ImagesToLuxenstudioDataset(ColmapConverterToLuxenstudioDataset):
