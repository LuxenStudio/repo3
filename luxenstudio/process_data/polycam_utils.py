...
"""Helper utils for processing polycam data into the luxenstudio format."""
...
def polycam_to_json(
    ...
    if glb_filename is not None:
        ...
        # shift the axes coordinates to match the luxenstudio ones (same as the cameras' coord system)
