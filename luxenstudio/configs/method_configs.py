...
from luxenstudio.data.datamanagers.lerf_datamanager import LERFDataManagerConfig
from luxenstudio.models.lerf import LERFModelConfig
from luxenstudio.pipelines.lerf_pipeline import LERFPipelineConfig, OpenCLIPNetworkConfig
...
method_configs["lerf"] = TrainerConfig(
    ...
    pipeline=LERFPipelineConfig(
        datamanager=LERFDataManagerConfig(
            dataparser=LuxenstudioDataParserConfig(train_split_fraction=0.99),
