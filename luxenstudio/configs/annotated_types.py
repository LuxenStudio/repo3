...
from luxenstudio.configs.dataparser_configs import dataparser_configs
from luxenstudio.configs.external_methods import get_external_methods
from luxenstudio.configs.method_configs import descriptions as method_descriptions
...
from luxenstudio.plugins.registry import discover_dataparsers, discover_methods
...
# Register all possible external methods which can be installed with Luxenstudio
all_methods, all_descriptions = merge_methods(
