...
import torch
import torchvision
from luxenacc.cameras import opencv_lens_undistortion, opencv_lens_undistortion_fisheye
from torch.nn import Parameter
from torchtyping import TensorType

import luxenstudio.utils.math
...
# This should be consistent with the `luxenstudio/process_data/colmap_utils.py`
            ...
            if distortion_params is not None:
                ...
                if mask.any():
                    if distortion_params_delta is not None:
                        ...
                        # try to use luxenacc to accelerate if we don't need to optimize distortion params
                        try:
                ...
                if mask.any():
                    ...
                    # use luxenacc which does not provide gradient
