...
class TCNNLuxenactoField(Field):
...
class TorchLuxenactoField(Field):
    """
...
field_implementation_to_class: Dict[str, Type[Field]] = {"tcnn": TCNNLuxenactoField, "torch": TorchLuxenactoField}
