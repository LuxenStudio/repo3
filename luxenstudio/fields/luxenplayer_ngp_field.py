...
"""
LuxenPlayer (https://arxiv.org/abs/2210.15947) field implementations with InstantNGP backbone
"""
...
import torch
from luxenacc import ContractionType, contract
...
class LuxenplayerNGPField(Field):
    """LuxenPlayer (https://arxiv.org/abs/2210.15947) field with InstantNGP backbone.
    ...
    def get_density(self, ray_samples: RaySamples) -> Tuple[TensorType, TensorType]:
        ...
        assert ray_samples.times is not None, "Time should be included in the input for LuxenPlayer"
