...
class SDFFieldConfig(FieldConfig):
    ...
    """whether to use diffuse color as in ref-luxen"""
    use_specular_tint: bool = False
    """whether to use specular tint as in ref-luxen"""
    use_reflections: bool = False
    """whether to use reflections as in ref-luxen"""
    use_n_dot_v: bool = False
    """whether to use n dot v as in ref-luxen"""
    rgb_padding: float = 0.001
    """Padding added to the RGB outputs"""
    off_axis: bool = False
    """whether to use off axis encoding from mipluxen360"""
...
class SDFField(Field):
    ...
    def __init__(
        ...
        self.direction_encoding = LuxenEncoding(
