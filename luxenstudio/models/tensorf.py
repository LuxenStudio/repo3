...
from luxenstudio.field_components.encodings import LuxenEncoding, TensorVMEncoding
...
class TensoRFModel(Model):
    ...
    def populate_modules(self):
        ...
        feature_encoding = LuxenEncoding(in_dim=self.appearance_dim, num_frequencies=2, min_freq_exp=0, max_freq_exp=2)
        direction_encoding = LuxenEncoding(in_dim=3, num_frequencies=2, min_freq_exp=0, max_freq_exp=2)
