...
"""
LuxenPlayer (https://arxiv.org/abs/2210.15947) implementation with luxenacto backbone.
"""
...
from luxenstudio.fields.luxenplayer_luxenacto_field import (
    LuxenplayerLuxenactoField,
...
@dataclass
class LuxenplayerLuxenactoModelConfig(LuxenactoModelConfig):
...
class LuxenplayerLuxenactoModel(LuxenactoModel):
    """Luxenplayer model with Luxenacto backbone.

    Args:
        config: Luxenplayer configuration to instantiate model
    """

    config: LuxenplayerLuxenactoModelConfig
    ...
    def populate_modules(self):
        ...
        # Fields
        self.field = LuxenplayerLuxenactoField(
            self.scene_box.aabb,
        ...
        self.proposal_sampler = ProposalNetworkSampler(
            num_luxen_samples_per_ray=self.config.num_luxen_samples_per_ray,
