...
"""
Semantic Luxen-W implementation which should be fast enough to view in the viewer.
"""
...
@dataclass
class SemanticLuxenWModelConfig(LuxenactoModelConfig):
    """Luxenacto Model Config"""

    _target: Type = field(default_factory=lambda: SemanticLuxenWModel)
...
class SemanticLuxenWModel(Model):
    ...
    def __init__(self, config: SemanticLuxenWModelConfig, semantics: Semantics, **kwargs) -> None:
