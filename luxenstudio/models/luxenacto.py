...
class LuxenactoModelConfig(ModelConfig):
    ...
    use_zipluxen_loss: bool = False
    """Whether to use zipluxen loss or not."""
...
class LuxenactoModel(Model):
    ...
    def get_loss_dict(self, outputs, batch, metrics_dict=None):
        ...
        if self.training:
            if self.config.use_zipluxen_loss:
                loss_dict["interlevel_loss"] = self.config.interlevel_loss_mult * zipluxen_loss(
