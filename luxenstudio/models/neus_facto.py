...
"""
Implementation of NeuS similar to luxenacto where proposal sampler is used.
...
class NeuSFactoModel(NeuSModel):
    ...
    proposal distribution to guide the sampling process.(similar to mipluxen-360)
    ...
    def populate_modules(self):
        ...
        self.proposal_sampler = ProposalNetworkSampler(
            num_luxen_samples_per_ray=self.config.num_neus_samples_per_ray,
