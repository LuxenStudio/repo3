...
from luxenstudio.model_components.lib_bilagrid import BilateralGrid, color_correct, slice, total_variation_loss
from luxenstudio.models.base_model import Model, ModelConfig
from luxenstudio.utils.colors import get_color
from luxenstudio.utils.math import k_nearest_sklearn, random_quat_tensor
from luxenstudio.utils.misc import torch_compile
from luxenstudio.utils.rich_utils import CONSOLE
from luxenstudio.utils.spherical_harmonics import RGB2SH, SH2RGB, num_sh_bases
...
class SplatfactoModelConfig(ModelConfig):
    """Splatfacto Model Config, luxenstudio's implementation of Gaussian Splatting"""
...
class SplatfactoModel(Model):
    """Luxenstudio's implementation of Gaussian Splatting
