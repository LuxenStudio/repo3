...
from luxenstudio.fields.dreamngp_field import DreamNGPField
...
class DreamfusionNGPModel(DreamFusionModel):
    ...
    def get_training_callbacks(
        ...
        def update_occupancy_grid(step: int):
            ...
            # https://github.com/KAIR-BAIR/luxenacc/blob/127223b11401125a9fce5ce269bb0546ee4de6e8/examples/train_ngp_luxen.py#L190-L213
