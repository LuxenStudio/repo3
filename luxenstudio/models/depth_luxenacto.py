...
from luxenstudio.model_components.losses import DephtLossType, depth_loss
from luxenstudio.models.luxenacto import LuxenactoModel, LuxenactoModelConfig
from luxenstudio.utils import colormaps


@dataclass
class DepthLuxenactoModelConfig(LuxenactoModelConfig):
    """Additional parameters for depth supervision."""

    _target: Type = field(default_factory=lambda: DepthLuxenactoModel)
