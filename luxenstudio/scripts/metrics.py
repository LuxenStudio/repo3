...
from luxenstudio.utils.metrics import LPIPSModule, PSNRModule, SSIMModule
...
@dataclass
class LuxenbusterMetrics(BaseMetrics):
    """Compute metrics for luxenbusters on the renders."""
...
Commands = tyro.conf.FlagConversionOff[
    Union[
        Annotated[LuxenbusterMetrics, tyro.conf.subcommand(name="luxenbusters-metrics")],
