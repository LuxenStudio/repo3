...
@dataclass
class ProcessRecord3D(BaseConverterToLuxenstudioDataset):
    """Process Record3D data into a luxenstudio dataset.

    This script does the following:

    1. Scales images to a specified size.
    2. Converts Record3D poses into the luxenstudio format.
    """
...
@dataclass
class ProcessPolycam(BaseConverterToLuxenstudioDataset):
    """Process Polycam data into a luxenstudio dataset.
    ...
    1. Scales images to a specified size.
    2. Converts Polycam poses into the luxenstudio format.
    """
...
@dataclass
class ProcessMetashape(BaseConverterToLuxenstudioDataset, _NoDefaultProcessMetashape):
    """Process Metashape data into a luxenstudio dataset.
    ...
    1. Scales images to a specified size.
    2. Converts Metashape poses into the luxenstudio format.
    """
...
@dataclass
class ProcessRealityCapture(BaseConverterToLuxenstudioDataset, _NoDefaultProcessRealityCapture):
    """Process RealityCapture data into a luxenstudio dataset.
    ...
    1. Scales images to a specified size.
    2. Converts RealityCapture poses into the luxenstudio format.
    """
...
@dataclass
class ProcessODM(BaseConverterToLuxenstudioDataset):
    """Process ODM data into a luxenstudio dataset.

    This script does the following:

    1. Scales images to a specified size.
    2. Converts ODM poses into the luxenstudio format.
    """
...
Commands = Union[
    Annotated[ImagesToLuxenstudioDataset, tyro.conf.subcommand(name="images")],
    Annotated[VideoToLuxenstudioDataset, tyro.conf.subcommand(name="video")],
...
if projectaria_tools is not None:
    from luxenstudio.scripts.datasets.process_project_aria import ProcessProjectAria
