...
class EyefulTowerDownload(DatasetDownload):
    ...
    def convert_cameras_to_luxenstudio_transforms(
        ...
        """Converts EyefulTower cameras.json format to Luxenstudio's transforms.json format
        ...
        This function takes the cameras.json file and converts it to the transforms.json Luxenstudio expects, with the
        ...
        Returns:
            Dict in the Luxenstudio transforms.json format, with scaled camera parameters, splits, and optional metadata.
        """
        output = {}
    ...
    @staticmethod
    def subsample_luxenstudio_transforms(transforms: dict, n: int):
        """Uniformly samples n frames from a Luxenstudio transforms.json dict.

        Args:
            transforms: Dictionary in Luxenstudio transforms.json format
    ...
    def download(self, save_dir: Path) -> None:
        ...
        * Generates Luxenstudio transform.json for each resolution. Additionally generates transforms_300.json and
