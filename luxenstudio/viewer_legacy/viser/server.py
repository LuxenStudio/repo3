...
from .messages import GuiUpdateMessage, LuxenstudioMessage
...
class ViserServer(MessageApi):
    ...
    @override
    def _queue(self, message: LuxenstudioMessage) -> None:
    ...
    def register_handler(
        self, message_type: Type[LuxenstudioMessage], handler: Callable[[LuxenstudioMessage], None]
    ) -> None:
