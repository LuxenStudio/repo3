...
from luxenactory.graphs.modules.ray_sampler import NGPSpacedSampler
...
class NGPGraph(Graph):
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        accumulated_weight, accumulated_depth, accumulated_color, mask = luxenactory_cuda.VolumeRenderer.apply(
