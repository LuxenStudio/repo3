...
export default function LandingModel(props: LandingModalProps) {
  ...
  const text_1 = `At the top right is the Status Panel where you can connect to a WebSocket and see the train/eval status of your Luxen model. The WebSocket URL takes the form <domain-or-ip_address>:<port>.`;
  const text_2 =
      ...
      >
        <Box className="LandingModal-box">
          <Typography id="modal-modal-title" component="div">
            Welcome to the Luxenactory Viewer!{' '}
          ...
          >
            <div className="LandingModel-content">
              ...
              <Button
                className="LandingModal-button"
                variant="outlined"
                href="https://plenoptix-luxenactory.readthedocs-hosted.com/en/latest/index.html"
                target="_blank"
                rel="noopener noreferrer"
              >
                Documentation
