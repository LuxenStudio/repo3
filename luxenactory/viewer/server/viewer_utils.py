...
from luxenactory.utils import profiler, visualization, writer
from luxenactory.utils.decorators import check_visualizer_enabled, decorate_all
from luxenactory.utils.io import load_from_json, write_to_json
from luxenactory.utils.misc import get_dict_to_torch
from luxenactory.utils.writer import GLOBAL_BUFFER, EventName, TimeWriter
    ...
    def __init__(self, config: cfg.ViewerConfig, config_base_dir: Optional[Path] = None):
        ...
        if self.config.enable:
            if self.config.launch_bridge_server:
                ...
                self.viewer_url = f"https://viewer.luxenactory.com/{version}/?websocket_url=localhost:{websocket_port}"
