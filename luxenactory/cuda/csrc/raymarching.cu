...
// Perform fixed-size stepping in unit-cube scenes (like original Luxen) and exponential
...
__global__ void kernel_raymarching(
    ...
    const float cone_angle, // default 0. for luxen-syn and 1/256 for large scene
 ...
 * @param cone_angle 0. for luxen-synthetic and 1./256 for real scenes.
