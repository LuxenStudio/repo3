...
class NGPModel(Model):
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        # accumulation
        compact_weights, compact_ray_indices = luxenacc.volumetric_rendering_weights(
            packed_info,
            densities,
            ray_samples.frustums.starts,
            ray_samples.frustums.ends,
        )
        accumulated_color = luxenacc.volumetric_rendering_accumulate(compact_weights, compact_ray_indices, rgbs, n_rays)
        accumulated_weight = luxenacc.volumetric_rendering_accumulate(compact_weights, compact_ray_indices, None, n_rays)
        accumulated_depth = luxenacc.volumetric_rendering_accumulate(
            compact_weights,
            compact_ray_indices,
