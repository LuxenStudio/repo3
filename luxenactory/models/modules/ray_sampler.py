...
class ProposalNetworkSampler(Sampler):
    ...
    def __init__(
        ...
        num_luxen_samples_per_ray: int = 32,
        ...
        self.num_luxen_samples_per_ray = num_luxen_samples_per_ray
    ...
    def generate_ray_samples(
        ...
        for i_level in range(n + 1):
            is_prop = i_level < n
            num_samples = self.num_proposal_samples_per_ray if is_prop else self.num_luxen_samples_per_ray
            if i_level == 0:
