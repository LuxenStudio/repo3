...
from luxenactory.data.format.blender import load_blender_data
from luxenactory.data.format.friends import load_friends_data
from luxenactory.data.format.instant_ngp import load_instant_ngp_data
from luxenactory.data.format.mipluxen_360 import load_mipluxen_360_data
from luxenactory.data.structs import DatasetInputs
from luxenactory.utils.colors import get_color
from luxenactory.utils.io import get_absolute_path, load_from_pkl, make_dir, write_to_pkl
from luxenactory.utils.misc import get_hash_str_from_dict
...
def get_dataset_inputs(
    ...
    elif dataset_format == "mipluxen_360":
        dataset_inputs = load_mipluxen_360_data(
            get_absolute_path(data_directory),
            downscale_factor=downscale_factor,
            split="train",
        )
