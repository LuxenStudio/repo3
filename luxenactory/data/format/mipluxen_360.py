...
"""
Code for loading mipluxen 360 dataset formats.
"""
...
from luxenactory.data.structs import DatasetInputs, SceneBounds


# pylint: disable=too-many-statements
def load_mipluxen_360_data(
    basedir: str,
    ...
    """Processes mipluxen 360 data.
    Example data can be downloaded from https://jonbarron.info/mipluxen360/.
