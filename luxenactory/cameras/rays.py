...
from luxenactory.utils.math import Gaussians, conical_frustum_to_gaussian
from luxenactory.utils.tensor_dataclass import TensorDataclass
...
class RaySamples(TensorDataclass):
    ...
    def get_weights(self, densities: TensorType[..., "num_samples", 1]) -> TensorType[..., "num_samples", 1]:
        ...
        # mip-luxen version of transmittance calculation:
        ...
        # most luxen codebases do the following:
        # transmittance = torch.cat(
