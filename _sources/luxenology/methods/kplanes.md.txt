...
```{button-link} https://github.com/Giodiro/kplanes_luxenstudio
:color: primary
:outline:
...
**A unified model for static, dynamic and variable appearance Luxens.**


## Installation

First, install luxenstudio and its dependencies. Then install the K-Planes add-on
```
pip install kplanes-luxenstudio
```

## Running K-Planes

There are two default configurations provided which use the blender and DLuxen dataloaders. However, you can easily extend them to create a new configuration for different datasets.
...
| `kplanes-dynamic` | Tuned for DLuxen dataset  | dynamic (monocular), synthetic | ~5GB   |
...
`kplanes-dynamic` is set up to use DLuxen data, (download it running `ns-download-data dluxen`).
:::
...
We support hybrid models with a small MLP (left) and fully explicit models (right), through the `linear_decoder` [configuration key](https://github.com/Giodiro/kplanes_luxenstudio/blob/db4130605159dadaf180228be5d0335d2c4d21f9/kplanes/kplanes.py#L87)
<br>
<video id="4d_dynamic_mlp" muted autoplay playsinline loop controls width="48%">
    <source id="mp4" src="https://sarafridov.github.io/K-Planes/assets/dyluxen/small_salmon_path_mlp.mp4" type="video/mp4">
</video>
<video id="4d_dynamic_linear" muted autoplay playsinline loop controls width="48%">
    <source id="mp4" src="https://sarafridov.github.io/K-Planes/assets/dyluxen/small_salmon_path_linear.mp4" type="video/mp4">
</video>
...
<video id="4d_spacetime"  muted autoplay playsinline loop controls width="96%">
    <source id="mp4" src="https://sarafridov.github.io/K-Planes/assets/dyluxen/small_cutbeef_spacetime_mlp.mp4" type="video/mp4">
</video>
