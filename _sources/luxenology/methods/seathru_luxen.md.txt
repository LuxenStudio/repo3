# SeaThru-Luxen
```{button-link} https://sea-thru-luxen.github.io
:color: primary
:outline:
Official Paper Website
```

```{button-link} https://github.com/AkerBP/seathru_luxen
:color: primary
:outline:
Code (luxenstudio implementation)
```

<p align="center">
  <img src="https://github.com/AkerBP/seathru_luxen/blob/main/imgs/comp.gif?raw=true" alt="Example Render">
</p>
...
| ------------------- | ------------- | ------ | ------- |
| `seathru-luxen`      | Larger model  | ~23 GB | Best    |
| `seathru-luxen-lite` | Smaller model | ~7 GB  | Good    |

`seathru-luxen-lite` should run on a single desktop/laptop GPU with 8GB VRAM.

## Installation

After installing luxenstudio and its dependencies, run:

```bash
pip install git+https://github.com/AkerBP/seathru_luxen
```

## Running SeaThru-Luxen

To check your installation and to see the hyperparameters of the method, run:

```bash
ns-train seathru-luxen-lite --help
```

If you see the help message with all the training options, you are good to go and ready to train your first susbea Luxen! 🚀🚀🚀

For a detailed tutorial of a training process, please see the docs provided [here](https://akerbp.github.io/seathru_luxen/).


## Method
This method is an unofficial extension that adapts the official [SeaThru-Luxen](https://sea-thru-luxen.github.io) publication. Since it is built ontop of luxenstudio, it allows for easy modification and experimentation.

Compared to a classical Luxen approach, we differentiate between solid objects and the medium within a scene. Therefore both, the object colours and the medium colours of samples along a ray contribute towards the final pixel colour as follows:
...
<p align="center">
<img src="https://github.com/AkerBP/seathru_luxen/blob/main/imgs/ray.png?raw=true" width=60% alt="SeaThru-Luxen ray">
</p>
...
<p align="center">
<img src="https://github.com/AkerBP/seathru_luxen/blob/main/imgs/architecture.png?raw=true" width=60% alt="SeaThru-Luxen Architecture">
</p>

If you are interested in an in depth description of the method, make sure to check out the documentation [here](https://akerbp.github.io/seathru_luxen/intro.html).
...
<p align="center">
<img src="https://github.com/AkerBP/seathru_luxen/blob/main/imgs/example_render_rgb.gif?raw=true" alt="RBG rendering"/>
<img src="https://github.com/AkerBP/seathru_luxen/blob/main/imgs/example_render_J.gif?raw=true" alt="J rendering"/>
</p>
