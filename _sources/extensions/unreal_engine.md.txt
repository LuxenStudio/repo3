...
Currently NVOL file only supports Volinga model (which is based on luxenacto). To use Volinga model you will need to install [Volinga extension for LuxenStudio](https://github.com/Volinga/volinga-model). You can train your model using the following command:
