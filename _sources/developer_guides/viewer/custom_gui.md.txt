...
To define a custom element, create an instance of one of the provided classes in `luxenstudio.viewer.viewer_elements`, and assign it as a class variable in your `nn.Module`.

```python
from luxenstudio.viewer.viewer_elements import ViewerNumber
...
```python
from luxenstudio.viewer.viewer_elements import *
