...
BLACKLIST = ["graph_semantic_luxen.yaml", "graph_mipluxen_360.yaml", "graph_instant_ngp.yaml"]
...
def set_reduced_config(config: DictConfig):
    ...
    config.data.image_dataset_train._target_ = "luxenactory.data.image_dataset.ImageDataset"

    config.data.dataset_inputs_train = {
        "_target_": "luxenactory.data.datasets.Blender",
    ...
    config.data.image_dataset_eval._target_ = "luxenactory.data.image_dataset.ImageDataset"
