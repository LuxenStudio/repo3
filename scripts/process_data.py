...
from luxenstudio.utils import colmap_utils, install_checks, io
...
def polycam_to_json(
    ...
    """Convert Polycam data into a luxenstudio dataset.
    ...
    for i, image_filename in enumerate(image_filenames):
        ...
        # Transform matrix to luxenstudio format. Please refer to the documentation for coordinate system conventions.
