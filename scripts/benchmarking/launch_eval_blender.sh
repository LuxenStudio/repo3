helpFunction_launch_eval()
{
   ...
   echo -e "\t-c name of method to benchmark (e.g. graph_mipluxen, graph_instant_ngp)"
...
for dataset in ${DATASETS[@]}; do
    ...
    checkpoint_dir="${output_dir}/blender_${dataset}_${month}-${date}-${year}/${base_config_name}/${year}-${month}-${date}_${seconds}/luxenactory_models/"
