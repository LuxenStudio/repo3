...
class RenderTrajectory:
    ...
    seconds: float = 5.0
    # A hack to double the number of samples for the luxenacto method.
    double_luxenacto_luxen_samples: bool = True
    ...
    def main(self) -> None:
        ...
        _, pipeline, _ = eval_setup(
            self.load_config,
            double_luxenacto_luxen_samples=self.double_luxenacto_luxen_samples,
