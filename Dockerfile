...
# Install hloc 1.4 as alternative feature detector and matcher option for luxenstudio.
...
# Copy luxenstudio folder and give ownership to user.
COPY --chown=${USER_UID}:${USER_GID} . /home/${USERNAME}/luxenstudio
...
# Switch to workspace folder and install luxenstudio cli auto completion
WORKDIR /workspace
