...
# Install hloc master (last release (1.3) is too old) as alternative feature detector and matcher option for luxenstudio.
...
ADD . /home/user/luxenstudio
USER root
RUN chown -R user /home/user/luxenstudio
USER ${USER_ID}
