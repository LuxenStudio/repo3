...
from pyrad.luxen.field_modules.encoding import Encoding, Identity, LuxenEncoding
from pyrad.luxen.field_modules.field_heads import DensityFieldHead, FieldHeadNames, RGBFieldHead, SemanticFieldHead
from pyrad.luxen.field_modules.mlp import MLP
from pyrad.luxen.fields.base import Field
from pyrad.luxen.fields.luxen_field import LuxenField
from pyrad.luxen.graph.vanilla_luxen import LuxenGraph
from pyrad.luxen.renderers import SemanticRenderer
from pyrad.structures.rays import PointSamples, RayBundle
from pyrad.utils import writer


class SemanticLuxenField(Field):
    """Semantic-Luxen field"""
...
class SemanticLuxenGraph(LuxenGraph):
    """Semantic-Luxen graph"""
    ...
    def populate_fields(self):
        ...
        self.field_fine = SemanticLuxenField(
