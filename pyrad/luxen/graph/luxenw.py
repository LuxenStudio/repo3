...
from pyrad.luxen.field_modules.encoding import LuxenEncoding
from pyrad.luxen.field_modules.field_heads import FieldHeadNames
from pyrad.luxen.fields.luxen_field import LuxenField
from pyrad.luxen.fields.luxenw_field import VanillaLuxenWField
from pyrad.luxen.graph.base import Graph
from pyrad.luxen.loss import MSELoss
from pyrad.luxen.ray_sampler import PDFSampler, UniformSampler
from pyrad.luxen.renderers import AccumulationRenderer, DepthRenderer, RGBRenderer, UncertaintyRenderer
...
class LuxenWGraph(Graph):
    ...
    def populate_fields(self):
        ...
        self.field_fine = VanillaLuxenWField(
    ...
    def log_test_image_outputs(self, image_idx, step, batch, outputs):
        ...
        writer.put_image(name=f"img/image_idx_{image_idx}-luxenw", image=combined_image, step=step)
