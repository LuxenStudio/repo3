...
from pyrad.luxen.field_modules.embedding import Embedding
...
from pyrad.luxen.renderers import UncertaintyRenderer
from pyrad.structures.rays import RayBundle, RaySamples
from pyrad.utils import visualization, writer


class LuxenWField(Field):
    """The Luxen-W field which has appearance and transient conditioning."""
...
class LuxenWGraph(LuxenGraph):
    ...
    def log_test_image_outputs(self, image_idx, step, image, mask, outputs):
        ...
        writer.put_image(name="img/image_idx_{image_idx}-luxenw", image=combined_image, step=step)
