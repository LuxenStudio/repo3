...
luxenactory |:metal:| provides a simple API that allows for a seamless and simplified end-to-end process of creating, training, and testing Luxens.
...
* **Tutorials**: a great place to start if you are new to luxenactory. Contains a quick tour, installation, and an overview of the core structures that will allow you to get up and running with luxenactory |:metal:|
* **Tooling**: describes all of the additional support we provide to help you debug and improve your Luxens (e.g logging, performance profiling)
...
|                        |  PSNR                        | Rays / sec.                |
+========================+==============================+============================+
| Luxen                   |  |:hourglass_flowing_sand:|  | |:hourglass_flowing_sand:| |
+------------------------+------------------------------+----------------------------+
