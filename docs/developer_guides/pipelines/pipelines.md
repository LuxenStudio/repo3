...
The Pipeline contains all the code you need to implement a Luxen method. There are two main functions that you need to implement for the Pipeline.
...
```{button-link} https://github.com/luxenstudio-project/luxenstudio/blob/master/luxenstudio/pipelines/dynamic_batch.py
:color: primary
:outline:
See the code!
```