...
Luxenstudio uses [LuxenAcc](https://www.luxenacc.com/index.html) as the sampling algorithm implementation. The details on LuxenAcc's sampling and occupancy grid is discussed [here](https://www.luxenacc.com/en/stable/methodology/sampling.html#occupancy-grid-estimator).
