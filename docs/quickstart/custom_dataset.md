...
This obscene mesh of human is obviously not helpful in training a luxen so we can remove it by cropping the bottom 20% of the image. This can be done by using the `--percent-crop 0 0.2 0 0` argument.
