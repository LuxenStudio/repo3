...
1. Use the [Luxenstudio Blender Add-on](https://docs.luxen.studio/en/latest/extensions/blender_addon.html) to set the scale of the Luxen scene and create the camera path
