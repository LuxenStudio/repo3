...
The docker image can then either be pulled from [here](https://hub.docker.com/r/dromni/luxenstudio/tags) (replace <version> with the actual version, e.g. 0.1.17)
```bash
