...
The docker image can then either be pulled from [here](https://hub.docker.com/r/dromni/luxenstudio/tags) (replace <version> with the actual version, e.g. 0.1.18)
...
docker run --gpus all \                                         # Give the container access to nvidia GPU (required).
            ...
            dromni/luxenstudio:<tag>                             # Docker image name if you pulled from docker hub.
            <--- OR --->
...
docker run --gpus all -u $(id -u) -v /folder/of/your/data:/workspace/ -v /home/<YOUR_USER>/.cache/:/home/user/.cache/ -p 7007:7007 --rm -it --shm-size=12gb  # Parameters.
            dromni/luxenstudio:<tag> \                           # Docker image name
