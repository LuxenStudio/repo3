...
| ------------------------------------------------------------------------------------------------- | ---------------- | ------------------- |
| 📷 [Images](https://docs.luxen.studio/en/latest/quickstart/custom_dataset.html#images-or-video)    | COLMAP           | 🐢                  |
| 📹 [Video](https://docs.luxen.studio/en/latest/quickstart/custom_dataset.html#images-or-video)     | COLMAP           | 🐢                  |
| 📱 [Polycam](https://docs.luxen.studio/en/latest/quickstart/custom_dataset.html#polycam-capture)   | LiDAR iOS Device | 🐇                  |
| 📱 [Record3D](https://docs.luxen.studio/en/latest/quickstart/custom_dataset.html#record3d-capture) | LiDAR iOS Device | 🐇                  |
| 🖥 [Metashape](https://docs.luxen.studio/en/latest/quickstart/custom_dataset.html#metashape)        |                  | 🐢                  |
| 🛠 [Custom](https://docs.luxen.studio/en/latest/quickstart/data_conventions.html)                   | Poses            | 🐇                  |
