...
Download the original Luxen Blender dataset. We support the major datasets and allow users to create their own dataset, described in detail [here](https://plenoptix-luxenstudio.readthedocs-hosted.com/en/latest/tutorials/data/index.html).
...
And that's it for getting started with the basics of luxenstudio. If you're interested in learning more on how to create your own pipelines, develop with the viewer, run benchmarks, and more, please check out some of the qucklinks below or visit our [documentation](https://docs.luxen.studio/en/latest/) directly.
...
| **Educational Guides** |
| [Model Descriptions](https://docs.luxen.studio/en/latest/guides/index.html)               | Description of all the models supported by luxenstudio and explanations of component parts.                                    |
...
**If you are looking for a feature that is not currently supported, please do not hesitate to contact the luxenstudio team!**
